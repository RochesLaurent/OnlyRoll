    ...
    <div class="min-h-screen bg-gradient-to-br from-primary-900 via-primary-800 to-secondary-900">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <!-- Logo -->
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        <a href="#features" class="text-secondary-300 hover:text-secondary-50 transition-colors">
                            Fonctionnalités
                        </a>
        ...
        <section class="relative py-20 lg:py-32">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <!-- Titre principal -->
                <h1 class="text-4xl md:text-6xl font-bold text-secondary-50 mb-6">
                    OnlyRoll
                </h1>
                <p class="text-xl md:text-2xl text-secondary-200 mb-4">
        ...
        <section id="features" class="py-20 bg-secondary-50/5">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-center text-secondary-50 mb-16">
                    Fonctionnalités
                </h2>
        ...
        <section class="py-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-3xl font-bold text-secondary-50 mb-8">
                    Interface
                </h2>
                <p class="text-lg text-secondary-400 mb-12">
                    Aperçu interface
                </p>
