<template>
    <div class="text-center space-y-6">
        ...
        <!-- Bouton de redirection vers login -->
            <RouterLink
                to="/auth/login"
                class="block w-full px-4 py-3 bg-primary-500 hover:bg-primary-600 
            ...
            <button
                ...
                class="block w-full px-4 py-3 bg-secondary-700 hover:bg-secondary-600
                    disabled:bg-secondary-600 disabled:cursor-not-allowed
                    text-secondary-200 font-medium rounded-lg
                    transition-colors duration-200"
            >
        ...
        <div class="text-center pt-4 border-t border-secondary-700">
            <p class="text-xs text-secondary-500">
                ...
                <a href="mailto:support@onlyroll.com" class="text-primary-400 hover:text-primary-300 transition-colors">
